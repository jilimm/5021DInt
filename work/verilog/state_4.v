    ...
    case (M_state_q)
      MAIN_state: begin
        ...
        if (M_mainState_result != 2'h0 && M_mainState_rowOn == 4'ha) begin
          ...
          scoreDisplay[8+3-:4] = M_translater_ascii[2+0-:1];
          scoreDisplay[4+3-:4] = M_translater_ascii[1+0-:1];
          scoreDisplay[0+3-:4] = M_translater_ascii[0+0-:1];
        end else begin
          if (M_mainState_result == 2'h0 && M_mainState_rowOn == 4'ha) begin
